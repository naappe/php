...
export class TranslationBrain{
  ...
  lookupDhivehi(token){
    ...
    const predication=this.analyzeNounPredication(token);if(predication)return predication.english||'is/classifies as';
